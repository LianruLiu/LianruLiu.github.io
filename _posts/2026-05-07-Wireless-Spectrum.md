...
### 1. Listed Carriers and Spectrum License Holders
...
### Summary: A Framework, Not a Trade

| Category | Core Thesis | Key Risk |
|---|---|---|
| Listed carriers | Spectrum as appreciating balance sheet asset | Regulatory changes to license terms |
| Tower companies | Densification tailwind, long-term lease cash flows | Carrier consolidation reducing tenancy |
...
*Spectrum is invisible. That is precisely why it is so easy to underestimate.*
