...
虽然现代 AI 芯片展现出庞大的算力，但其能耗水平相较于人类大脑依然是天壤之别。
...
生物神经元通过离散的电脉冲、精确的时间节律、高度适应性与非线性动态来处理信息。
...
低成本且可规模化处理的材料，能否忠实再现生物神经元复杂的脉冲放电动态？
...
这些器件能否同时兼具柔性与可扩展性，从而为下一代生物混合脑机接口铺平道路？
...
最令人瞩目的是，其生成的脉冲波形成功刺激了离体小鼠小脑切片中的浦肯野神经元。
...
这些印刷忆阻网络有望成为下一代类脑计算中低成本、可无限扩展的基础物理单元。
...
在卷对卷大规模量产中确保极端的器件一致性，是一项艰巨的工程挑战。
...
与其将生物算法强行塞入冰冷的硅基逻辑，不如直接从材料学着手，让其自发呈现生物系统的物理特征。
...
这种计算架构的底层重构所带来的复利回报，将远远超过 GPU 算力再提升 10% 的蝇头小利。
